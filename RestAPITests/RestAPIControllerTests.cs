...
/// </summary>
public class RestAPIControllerTests(WebApplicationFactory<RestAPIController> factory)
    : IClassFixture<WebApplicationFactory<RestAPIController>>
{
    ...
    public async Task Post_DocumentTransform_ShouldReturnTransformedDocument_WhenInputIsValid()
    {
        ...
        var request = new RestAPIController.DocumentTransformRequest
        {
