...
/// <param name="Via">The list of principal cities that the train passes through. (Separator is ', ')</param>
...
public record DepartureEntry(string Destination, string Via, string DepartureHour, string Train, string Platform);
