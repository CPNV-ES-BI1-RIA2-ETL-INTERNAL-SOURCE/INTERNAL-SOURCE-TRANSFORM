...
/// <param name="Date">The date from which the departures are listed in sentence context (Ex. 'Départ pour le 9 décembre 2024').
/// <param name="Departure">A list of departures</param>
public record DeparturesDocument(string RelatedTrainStationName, string Date, List<Departure> Departures);
